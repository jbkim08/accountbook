...
public class ExcelController {
    ...
    public ResponseEntity<InputStreamResource> downloadExcel(@AuthenticationPrincipal User user) throws IOException {
        // 전체 내역 조회 (페이징 없이 전체 출력)
        ByteArrayInputStream in = excelService.transactionsToExcel(transactionService.getAllTransactions(user.getUsername()));
